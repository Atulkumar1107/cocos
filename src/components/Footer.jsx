...
export default function Footer() {
  ...
  return (
    <footer className="relative bg-gray-900 text-white py-16 px-6 sm:px-16 overflow-hidden">
      {/* Sunset Beach Background */}
      <div 
        className="absolute inset-0 bg-cover bg-center bg-no-repeat"
        style={{
          backgroundImage: "url('https://res.cloudinary.com/dbjcqykzz/image/upload/v1762408065/footer-sunset-bg_xhsugu.jpg')",
        }}
      ></div>
      ...
      {/* Top gradient fade for smooth blend with Testimonials */}
      <div 
        className="absolute top-0 left-0 right-0 h-32 z-[5]"
        style={{
          background: 'linear-gradient(to bottom, rgba(17, 24, 39, 1) 0%, rgba(17, 24, 39, 0.5) 50%, rgba(17, 24, 39, 0) 100%)'
        }}
      ></div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-12 mb-12">
          ...
          <div>
            ...
            <p className="text-gray-300 mb-6">
              Subscribe to our newsletter for updates, special offers, and island news.
            </p>
            ...
            <form onSubmit={handleSubscribe} className="mb-6">
              <div className="flex flex-col gap-3">
                <input
                  ...
                  required
                  className="px-4 py-3 rounded-xl bg-gray-800 border-2 border-gray-700 text-white placeholder-gray-400 focus:border-orange-500 focus:outline-none transition"
                />
                <button
                  type="submit"
                  className="bg-orange-600 text-white px-6 py-3 rounded-xl font-bold hover:bg-orange-700 transition shadow-lg"
                >
                  Subscribe
                </button>
              </div>
