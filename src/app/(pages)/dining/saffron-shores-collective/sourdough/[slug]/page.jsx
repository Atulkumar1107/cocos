...
This artisan bread is perfect for everything from sandwiches to toasts or simply enjoyed on its own. Made with care and no artificial additives, it's a wholesome addition to any meal.`,
  ...
  "whole-wheat-sourdough": {
    ...
    sizes: [
      { name: "Small", priceWhole: 9.0, priceSliced: 9.5, weight: "400g" },
      { name: "Medium", priceWhole: 13.0, priceSliced: 13.5, weight: "700g" },
      { name: "Large", priceWhole: 16.0, priceSliced: 16.5, weight: "1kg" },
    ],
  },
  "rye-sourdough": {
    id: "rye-sourdough",
    ...
    sizes: [
      { name: "Small", priceWhole: 9.5, priceSliced: 10.0, weight: "400g" },
      { name: "Medium", priceWhole: 13.5, priceSliced: 14.0, weight: "700g" },
      { name: "Large", priceWhole: 16.5, priceSliced: 17.0, weight: "1kg" },
    ],
  },
  "multigrain-sourdough": {
    ...
    sizes: [
      { name: "Small", priceWhole: 10.0, priceSliced: 10.5, weight: "400g" },
      { name: "Medium", priceWhole: 14.0, priceSliced: 14.5, weight: "700g" },
      { name: "Large", priceWhole: 17.0, priceSliced: 17.5, weight: "1kg" },
    ],
  },
  "seeded-sourdough": {
    id: "seeded-sourdough",
...
Perfect for those seeking extra nutrition and flavor. The seeds add healthy fats, protein, and a wonderful nutty taste that pairs beautifully with both sweet and savory toppings.`,
    ...
    sizes: [
      { name: "Small", priceWhole: 11.0, priceSliced: 11.5, weight: "400g" },
      { name: "Medium", priceWhole: 15.0, priceSliced: 15.5, weight: "700g" },
      { name: "Large", priceWhole: 18.0, priceSliced: 18.5, weight: "1kg" },
    ],
  },
};
    ...
    <>
      ...
      <div className="relative flex min-h-[60vh] items-center justify-center bg-zinc-50 dark:bg-black overflow-hidden">
        <div
          ...
          style={{
            backgroundImage:
              "url('https://res.cloudinary.com/dbjcqykzz/image/upload/v1763119022/pexels-catscoming-1571073_les0sm.jpg')",
          }}
        />
        {/* Overlay */}
        ...
        <main className="relative z-10 flex w-full max-w-6xl flex-col items-center justify-center px-6 py-20 text-center sm:px-16">
          ...
          <div className="flex items-center justify-center space-x-2 text-sm text-white/90">
            ...
            <span>/</span>
            <Link
              href="/dining/saffron-shores-collective/sourdough"
              className="hover:text-white transition"
            >
              Sourdough
            </Link>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
            ...
            <div className="space-y-6">
              ...
              <div>
                ...
                <p className="text-lg text-gray-600">{product.availability}</p>
              </div>
              ...
              <div className="border-t border-b border-gray-200 py-4">
                ...
                <p className="text-sm text-gray-600 mt-1">
                  ...
                  {product.sizes.find((s) => s.name === selectedSize)?.weight})
                </p>
              </div>
                ...
                <div className="flex items-start space-x-3">
                  ...
                  <div className="flex-1">
                    ...
                    <p className="text-sm text-gray-600 mb-1">
                      📅 Availability: {product.availability} (6:00 AM - 2:00
                      PM)
                    </p>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
            {relatedProducts.map((relatedProduct) => (
              <Link
                ...
                href={`/dining/saffron-shores-collective/sourdough/${relatedProduct.id}`}
