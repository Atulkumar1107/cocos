...
export default function FlightDaysListing() {
  ...
  const flightDayProducts = [
    ...
    },
    {
      ...
      image:
        "https://res.cloudinary.com/dbjcqykzz/image/upload/v1763117768/pexels-fariphotography-905847_j0hvbz.jpg",
      price: 23.0,
      category: "Pizza Night",
      time: "Pre-order for flight days",
      availability: "Tuesday & Friday",
    ...
    // SOURDOUGH (5 products)
    {
      ...
      type: "sourdough",
      description:
        "Made with flour, water, salt, and natural sourdough starter. Perfect for travel.",
      image:
        "https://res.cloudinary.com/dbjcqykzz/image/upload/v1763117827/pexels-catscoming-1571075_rr8d6z.jpg",
      price: 8.0,
    ...
    },
    {
      ...
      type: "sourdough",
      description:
        "Hearty whole wheat sourdough with nutty flavor. Rich in fiber and nutrients.",
      image:
    ...
    },
    {
      ...
      type: "sourdough",
      description:
        "Traditional rye sourdough with deep, earthy flavor. Perfect for sandwiches.",
      image:
    ...
    },
    {
      ...
      type: "sourdough",
      description:
        "Packed with seeds and grains. Nutty, wholesome, and delicious.",
      image:
        "https://res.cloudinary.com/dbjcqykzz/image/upload/v1763119050/pexels-renestrgar-33240983_miehfs.jpg",
      price: 10.0,
      category: "Artisan Bread",
      time: "Pre-order for flight days",
      availability: "Tuesday & Friday",
    },
    {
      ...
      type: "sourdough",
      description:
        "Loaded with sunflower, pumpkin, and sesame seeds. Crunchy crust with soft interior.",
      image:
  ...
  const getProductLink = (product) => {
    if (product.type === "pizza") {
      return `/dining/saffron-shores-collective/pizza/${product.slug}`;
    } else if (product.type === "sourdough") {
      return `/dining/saffron-shores-collective/sourdough/${product.slug}`;
    }
    return "#";
  };
    ...
    <>
      ...
      <div className="relative flex min-h-[60vh] items-center justify-center bg-zinc-50 dark:bg-black overflow-hidden">
        ...
        <div
          ...
          style={{
            backgroundImage:
              "url('https://res.cloudinary.com/dbjcqykzz/image/upload/v1763120550/pexels-freestockpro-1003864_ptdk6k.jpg')",
          }}
        />
      ...
      >
        ...
        <div className="relative z-10 mx-auto max-w-4xl text-center">
          <h2 className="text-3xl font-bold text-gray-900 mb-6">
            Whether you're flying in, flying out or transiting, Salty's has you
            covered!
          </h2>
          <div className="space-y-4 text-lg text-gray-700 leading-relaxed">
            <p>
              On plane days (Tuesdays & Fridays) we offer delicious pizzas to
              enjoy pre-flight or as an inflight meal. If you're transiting
              to/from Christmas Island, we will deliver to the transit lounge.
            </p>
            <p>
              You can also pre-order a freshly-baked sourdough loaf to take with
              you wherever your next destination is.
            </p>
            <p className="font-semibold text-gray-900 text-xl mt-6">
              ✈️ Pre-orders are essential to ensure we can have your meal ready
