  ...
  const menuCategories = [
    {
      ...
      name: "Pizza",
      description:
        "Wood-fired pizzas with fresh toppings. Perfect for Monday nights and weekend dinners.",
      image:
        "https://res.cloudinary.com/dbjcqykzz/image/upload/v1763117768/pexels-fariphotography-905847_j0hvbz.jpg",
      link: "/dining/saffron-shores-collective/pizza",
      icon: "🍕",
    },
    {
      id: 2,
      name: "Sourdough",
      description:
        "Freshly baked sourdough bread and artisan loaves made with traditional methods.",
      image:
        "https://res.cloudinary.com/dbjcqykzz/image/upload/v1763117827/pexels-catscoming-1571075_rr8d6z.jpg",
      link: "/dining/saffron-shores-collective/sourdough",
      icon: "🍞",
    },
    {
      id: 3,
      name: "Fish & Chips",
      description:
        "Friday special! Fresh local fish with crispy chips. Choose battered or grilled.",
      image:
        "https://res.cloudinary.com/dbjcqykzz/image/upload/v1763117894/pexels-farhad-19239122_vm2ifk.jpg",
      link: "/dining/saffron-shores-collective/fish-and-chips",
      icon: "🐟",
    },
    {
      id: 4,
      name: "Flight Days",
      description:
        "Pre-order your meals for plane days. Fresh baked goods and snacks ready for pickup.",
      image:
        "https://res.cloudinary.com/dbjcqykzz/image/upload/v1763117907/pexels-stefanstefancik-127905_liosxq.jpg",
      link: "/dining/saffron-shores-collective/flight-days",
      icon: "✈️",
    },
  ];
