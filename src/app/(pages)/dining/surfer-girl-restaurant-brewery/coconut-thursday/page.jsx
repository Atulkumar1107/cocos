    ...
    mains: [
      {
        ...
        description: "Mild Malay spices with coconut, zucchini, capsicum + spinach on a bed of activated carbon noodles",
        price: 34.00,
      ...
      },
      {
        ...
        description: "Oven baked trout + coconut, ginger, lime + tumeric sauce on a bed of coconut rice + quinoa side salad",
        price: 38.00,
        image: "https://res.cloudinary.com/dbjcqykzz/image/upload/v1763119758/pexels-shameel-mukkath-3421394-5638539_tsajab.jpg"
      },
      {
        ...
        description: "Slow cooked Malay rendang, medium spices, desiccated coconut, lemongrass + tumeric on coconut rice",
        price: 38.00,
        image: "https://res.cloudinary.com/dbjcqykzz/image/upload/v1763119515/pexels-carlosdamian-7800142_kom6gz.jpg"
      }
    ],
    desserts: [
      {
        ...
        description: "Select from a range of flavours; pure, lychee, passionfruit, cocoa and date, caramel or lime",
        price: 14.00,
    ...
    <>
      ...
      <div className="relative flex min-h-[60vh] items-center justify-center bg-zinc-50 dark:bg-black overflow-hidden">
        ...
        <div 
          ...
          style={{
            backgroundImage: "url('https://res.cloudinary.com/dbjcqykzz/image/upload/v1762838957/pexels-alexeydemidov-11821214_ydc6so.jpg')",
          }}
        />
