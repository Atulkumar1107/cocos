    ...
    starters: [
      {
        ...
        description: "Salty's sourdough with Italian herbs & local sea salt flakes",
        price: 12.00,
    ...
    mains: [
      {
        ...
        description: "Zucchini, spinach, onions on a bed of surfer girl pasta with a Mediterranean salad",
        price: 34.00,
      ...
      },
      {
        id: 5,
        name: "Beef Lasagne",
        description: "Surfer girl made beef lasagne based on a traditional Italian recipe with a Mediterranean side salad",
        price: 38.00,
      ...
      },
      {
        ...
        description: "Grain fed Angus fillet with a garlic prawns or a pepper mushroom sauce on a bed of mashed potatoes and Mediterranean side salad",
        price: 48.00,
    ...
    desserts: [
      {
        ...
        description: "Served in a coconut bowl - Tonight's options: Pure or Lime",
        price: 14.00,
      ...
      },
      {
        id: 9,
        name: "Cocos Tiramisu",
        description: "A locally made traditional Italian dessert - Mascarpone, eggs, coffee, biscuits & time",
        price: 18.00,
      ...
      },
      {
        id: 10,
        name: "Affogato",
        description: "Go on treat yourself after dessert on your last night in paradise - You deserve it! Espresso, Frangelica or Baileys liqueur, ice cream & garnished with desiccated coconut",
        price: 19.00,
        image: "https://res.cloudinary.com/dbjcqykzz/image/upload/v1763447243/pexels-christopher-spence-2153855819-32937255_yntbwx.jpg"
      }
    ]
  };
    ...
    <>
      ...
      <div className="relative flex min-h-[60vh] items-center justify-center bg-zinc-50 dark:bg-black overflow-hidden">
        ...
        <div 
          ...
          style={{
            backgroundImage: "url('https://res.cloudinary.com/dbjcqykzz/image/upload/v1763446702/pexels-robimsel-34762311_btyicb.jpg')",
          }}
        />
...
<main className="relative z-10 flex w-full max-w-6xl flex-col items-center justify-center px-6 py-20 text-center sm:px-16">
  ...
  <div className="flex items-center justify-center space-x-2 text-sm text-white/90 mt-8">
    ...
    <span>/</span>
    <span className="text-white font-semibold">Mediterranean Monday</span>
  </div>
</main>
      </div>
