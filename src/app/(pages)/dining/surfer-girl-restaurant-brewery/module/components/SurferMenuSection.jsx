  ...
  const menuCards = [
    {
      ...
      description: "Experience Mediterranean flavors with a tropical twist every Monday night",
      image: "https://res.cloudinary.com/dbjcqykzz/image/upload/v1763446702/pexels-robimsel-34762311_btyicb.jpg",
      category: "Dinner",
      time: "5pm - 9pm",
    ...
    },
    {
      ...
      description: "Indulge in coconut-based entrees, mains and desserts every Thursday",
      image: "https://res.cloudinary.com/dbjcqykzz/image/upload/v1762839524/pexels-anntarazevich-7466809_mr8l0e.jpg",
      category: "Dinner",
      time: "5pm - 9pm",
    ...
    },
    {
      ...
      description: "Start your Sunday with fresh breakfast overlooking the Indian Ocean",
      image: "https://res.cloudinary.com/dbjcqykzz/image/upload/v1763447559/pexels-burcu-bircan-680818596-30827426_bx1zlu.jpg",
      category: "Breakfast",
      time: "8am - 12pm",
    ...
    },
    {
      ...
      description: "Locally made cocktails, our craft beer, and curated wine selection",
      image: "https://res.cloudinary.com/dbjcqykzz/image/upload/v1763447824/pexels-pixabay-159291_nibpzt.jpg",
      category: "Drinks",
      ...
      >
        <div className="mx-auto max-w-4xl text-center">
          <div className="space-y-4 text-lg text-gray-700 leading-relaxed mb-8">
            <p>
              A restaurant brewery providing a unique Cocos Islands dining experiences under the stars and overlooking the Indian Ocean to the West.
            </p>
            <p>
              Enjoy a range of casual dinner meals (Monday & Thursday) & breakfast (Sunday).
            </p>
            <p>
              The restaurant is fully licensed serving locally made cocktails, local craft beer (our latest venture) and amazing coconut based entrees, mains and desserts.
            </p>
            <p className="font-semibold text-gray-900">
              Limited seating, bookings are essential. Book now via the form below or write up your name on the reservations board located outside the venue.
            </p>
          </div>

          {/* Book Now Button */}
          <Link 
             href="/dining/surfer-girl-restaurant-brewery/reservations" 
        ...
        <div className="relative z-10 mx-auto max-w-7xl">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 lg:grid-cols-4 gap-6">
            {menuCards.map((menu) => (
              <Link
                key={menu.id}
                href={`/dining/surfer-girl-restaurant-brewery/${menu.slug}`}
                className="group"
              >
