  ...
  const menuData = {
    ...
    toasties: [
      ...
      },
      {
        ...
        description:
          "Sourdough toastie or open with bacon, tomato, egg & cheese",
        price: 19.0,
        image:
      ...
      },
      {
        ...
        description:
          "Sourdough toastie or open with avo, spinach, tomato & cheese",
        price: 18.0,
        image:
    ...
    breakfast: [
      ...
      },
      {
        ...
        description:
          "Avo, baby spinach, cherry tomatoes on sourdough toast and drizzled with extra virgin olive oil and a balsamic glaze",
        price: 22.0,
        image:
      ...
      },
      {
        ...
        description:
          "Sautéed mushrooms with smashed avocado, cherry toms & salad",
        price: 24.0,
        image:
      ...
      },
      {
        ...
        name: "Big Breakfast",
        description:
          "Fried or scrambled eggs on sourdough, with bacon, mushrooms, avo, side salad and tomato relish",
        price: 32.0,
        image:
    ...
    drinks: [
      ...
      },
      {
        ...
        price: 0.0,
        image:
          "https://res.cloudinary.com/dbjcqykzz/image/upload/v1763118110/pexels-marta-dzedyshko-1042863-2775827_dhsyqk.jpg",
      },
      {
        id: 18,
        name: "Milkshakes",
        description:
          "Spearmint blitz, caramel deluxe, big banana wicked vanilla, strawberry kiss, chocolate royale, blueberry thrill",
        price: 0.0,
        image:
    ...
    <>
      ...
      <div className="relative flex min-h-[60vh] items-center justify-center bg-zinc-50 dark:bg-black overflow-hidden">
        ...
        <div
          ...
          style={{
            backgroundImage:
              "url('https://res.cloudinary.com/dbjcqykzz/image/upload/v1763447559/pexels-burcu-bircan-680818596-30827426_bx1zlu.jpg')",
          }}
        />
      ...
      >
        <div className="mx-auto max-w-5xl">
          ...
          {/* Sourdough Toasties */}
          <MenuSection
            title="SOURDOUGH TOASTIES or OPEN"
            items={menuData.toasties}
          />
          ...
          <div className="mb-16 p-6 bg-white/80 rounded-2xl border-2 border-gray-200">
            <h3 className="text-2xl font-bold text-gray-900 mb-3">
              Extra Serves / Add Ons
            </h3>
            <p className="text-lg text-gray-700">
              <span className="font-semibold">$3.00 each:</span> Bacon, Egg,
              Mushrooms, Avo, Hash Brown
            </p>
          </div>

          {/* Cold Drinks */}
          <MenuSection
            title="COLD DRINKS, SMOOTHIES & MILKSHAKES"
