import BookingAndGallery from "./module/components/galley_location";
import SaltysMenu from "./module/components/menu_options";

export default function Saltys() {
  return (
    <>
      {/* Hero Section */}
      <div className="relative flex min-h-screen items-center justify-center bg-zinc-50 dark:bg-black overflow-hidden">
        {/* Background Image - Same as dining main page */}
        <div 
        ...
        <main className="relative z-10 flex w-full max-w-5xl flex-col items-center justify-center px-6 py-32 text-center sm:px-16 mt-16 lg:mt-16">
          ...
          <p className="mb-12 max-w-2xl text-lg text-white/90 sm:text-xl">
            Your neighborhood spot for fresh coffee, homemade pastries, and wood-fired pizza
          </p>
        </main>
      </div>
      <SaltysMenu/>
