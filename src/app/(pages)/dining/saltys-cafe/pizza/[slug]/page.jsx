...
const pizzaDatabase = {
  "monday-pizza-night": {
    ...
    timeSlots: ["2:00 PM", "3:00 PM", "4:00 PM", "5:00 PM", "6:00 PM", "7:00 PM"],
...
Perfect for families, groups, or a casual dinner with friends. Pre-order recommended to avoid wait times during peak hours.`,
    ...
    variants: [
      { name: "Satay Chicken", price: 23.00 },
      { name: "BBQ Chicken", price: 23.00 },
      { name: "Mince Beef", price: 25.00 },
      { name: "Cheese Lovers", price: 23.00 },
      { name: "Lamb and Feta", price: 26.00 },
      { name: "Pumpkin", price: 23.00 },
      { name: "Vegetarian", price: 23.00 },
      { name: "Tandoori Lamb", price: 26.00 },
      { name: "Supreme", price: 25.00 },
      { name: "Pepperoni", price: 24.00 },
      { name: "Hawaiian", price: 23.00 },
  ...
  "friday-lunch-pizza": {
    ...
    variants: [
      { name: "Margherita", price: 22.00 },
      { name: "Pepperoni", price: 23.00 },
      { name: "Vegetarian", price: 23.00 },
      { name: "Hawaiian", price: 23.00 },
      { name: "BBQ Chicken", price: 24.00 },
    ]
  },
  "saturday-pizza-night": {
    ...
    timeSlots: ["5:00 PM", "5:30 PM", "6:00 PM", "6:30 PM", "7:00 PM", "7:30 PM", "8:00 PM"],
  ...
  const relatedProducts = [
    {
      ...
      price: 23.00,
      image: "https://res.cloudinary.com/dbjcqykzz/image/upload/v1763118293/pexels-yankrukov-5216394_idwpt0.jpg",
    },
    {
      id: "saturday-pizza-night",
      name: "Saturday Pizza Night",
    ...
    <>
      ...
      <div className="relative flex min-h-[60vh] items-center justify-center bg-zinc-50 dark:bg-black overflow-hidden">
        <div 
          ...
          style={{
            backgroundImage: "url('https://res.cloudinary.com/dbjcqykzz/image/upload/v1763118650/pexels-annija-mieze-427042079-15197931_i4qlk3.jpg')",
          }}
        />
         {/* Overlay */}
        ...
        <main className="relative z-10 flex w-full max-w-6xl flex-col items-center justify-center px-6 py-20 text-center sm:px-16">
          ...
          <div className="flex items-center justify-center space-x-2 text-sm text-white/90">
            ...
            <span>/</span>
            <Link href="/dining/saltys-cafe/pizza" className="hover:text-white transition">Pizza</Link>
            <span>/</span>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
            {relatedProducts.map((relatedProduct) => (
              <Link
                ...
                href={`/dining/saltys-cafe/pizza/${relatedProduct.id}`}
