  ...
  const venues = [
    {
      ...
      description:
        "Our outdoor restaurant located on the beach is the perfect place for sunset dinner and drinks with locally sourced ingredients.",
      image:
        "https://res.cloudinary.com/dbjcqykzz/image/upload/v1762427094/pexels-elevate-1267262_qup1uu.jpg",
    ...
    },
    {
      ...
      description:
        "Visit our café, bakery and takeaway joint near the airport for coffee, cakes, pizza and other tasty treats.",
      image:
    ...
    },
    {
      ...
      description:
        "Shop fresh local produce, artisan products, and handcrafted goods made right here on Saffron Shores Collective.",
      image:
        "https://res.cloudinary.com/dbjcqykzz/image/upload/v1762427191/pexels-kindelmedia-6994271_lymowy.jpg",
      link: "/fresh-produce",
      featured: false,
    },
  ];
      ...
      <div className="relative z-10 max-w-7xl mx-auto">
        ...
        <div className="text-center mb-16">
          ...
          <p className="text-lg text-zinc-600 max-w-2xl mx-auto">
            Experience authentic island flavors and culture across our unique
            locations
          </p>
        </div>
